...
class IK(object):
    def __init__(self, base_link, tip_link,
        ...
        :param urdf_string str: URDF string describing the robot. Must be provided.
        """
        if urdf_string is None:
            raise ValueError(
                "urdf_string must be provided. "
                "Load it from a file or subscribe to /robot_description."
            )
